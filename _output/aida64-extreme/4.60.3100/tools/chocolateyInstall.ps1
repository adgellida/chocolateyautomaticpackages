...
#$version = '4.60.3100'
$version = '4.60'
$uninstallRegistryPath_x86 = 'HKCU:\Software\Microsoft\Windows\CurrentVersion\Uninstall\AIDA64 Extreme_is1'
$uninstallRegistryPath_x64 = 'HKCU:\Software\Wow6432Node\Microsoft\Windows\CurrentVersion\Uninstall\AIDA64 Extreme_is1'
$installerType = 'EXE'
