...
$url = 'http://www.rarlab.com/rar/winrar-x64-{url_version}sc.exe'
}
...
##Georgian			1079
#elseif($LCID -eq "1079"){
#$url = 'http://www.rarlab.com/rar/winrar-x64-{url_version}ge.exe'
#}
...
##Slovak			1051
elseif($LCID -eq "1051"){
$url = 'http://www.rarlab.com/rar/winrar-x64-{url_version}sk.exe'
}

##Slovenian		
##Slovenian			1060
elseif($LCID -eq "1060"){
$url = 'http://www.rarlab.com/rar/winrar-x64-{url_version}slv.exe'
}
...
##Thai						1054
elseif($LCID -eq "1054"){
$url = 'http://www.rarlab.com/rar/winrar-x64-{url_version}th.exe'
}
...
##Chinese - Macao SAR					 5124
elseif(($LCID -eq "2052") -or ($LCID -eq "4100") -or ($LCID -eq "3076") -or ($LCID -eq "5124")){
$url = 'http://www.rarlab.com/rar/wrar{url_version}sc.exe'
}
...
##Slovenian			1060
elseif($LCID -eq "1060"){
$url = 'http://www.rarlab.com/rar/wrar{url_version}slv.exe'
}
...
##Thai						1054
elseif($LCID -eq "1054"){
$url = 'http://www.rarlab.com/rar/wrar{url_version}th.exe'
}
