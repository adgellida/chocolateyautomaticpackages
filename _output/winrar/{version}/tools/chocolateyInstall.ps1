$packageName = 'winrar'
$version_x64 = "WinRAR {}.0.0.20141006 (64-bit)"
$version_x86 = "WinRAR {}.0.0.20141006 (32-bit)"
$uninstallRegistryPath = "HKLM:\Software\Microsoft\Windows\CurrentVersion\Uninstall\WinRAR archiver"
$installerType = 'EXE'
$url = 'http://www.rarlab.com/rar/winrar-x64-52b1.exe'
$silentArgs = '/S'
$validExitCodes = @(0) #please insert other valid exit codes here, exit codes for ms http://msdn.microsoft.com/en-us/library/aa368542(VS.85).aspx
$LCID = (Get-Culture).LCID
$url_version_dot= '{}.0.0.20141006'
