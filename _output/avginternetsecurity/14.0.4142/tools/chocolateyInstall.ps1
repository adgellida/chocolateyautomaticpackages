...
$validExitCodes = @(0) #please insert other valid exit codes here, exit codes for ms http://msdn.microsoft.com/en-us/library/aa368542(VS.85).aspx
  ...
  if ($is64bit) {
	$url = 'http://download.avg.com/filedir/inst/avg_isct_x86_all_2014_4142a6696.exe'
	#$url = 'http://download.avg.com/filedir/inst/{anchor64}.exe'
  } else {
	$url = 'http://download.avg.com/filedir/inst/avg_isct_x86_all_2014_4142a6696.exe'
	#$url = 'http://download.avg.com/filedir/inst/{anchor32}.exe'
  }
