...
$url = 'http://products.kaspersky-labs.com/spanish/homeuser/kav2014/kav14.0.0.4651es-es.exe'
}

##Spanish - Mexico (es-mx)
elseif($LCID -eq "2058"){
$url = 'http://products.kaspersky-labs.com/spanish/homeuser/kav2014/kav14.0.0.4651es-mx.exe'
}
...
elseif($LCID -eq "1046"){
$url = 'http://products.kaspersky-labs.com/portuguese/homeuser/kav2014/kav14.0.0.4651pt-br.exe'
}

##Portuguese - Portugal (pt-pt)
elseif($LCID -eq "2070"){
$url = 'http://products.kaspersky-labs.com/portuguese/homeuser/kav2014/kav14.0.0.4651pt-pt.exe'
}
...
elseif($LCID -eq "2057"){
$url = 'http://products.kaspersky-labs.com/english/homeuser/kav2014/kav14.0.0.4651en-gb.exe'
}

##English
else{
$url = 'http://products.kaspersky-labs.com/english/homeuser/kav2014/kav14.0.0.4651abcdEN_5759.exe'
}
