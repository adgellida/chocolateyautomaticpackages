...
$validExitCodes = @(0) #please insert other valid exit codes here, exit codes for ms http://msdn.microsoft.com/en-us/library/aa368542(VS.85).aspx
  ...
  if ($is64bit) {
	$url = 'http://aa-download.avg.com/filedir/inst/avg_free_x64_all_2014_4354a7223.exe'
  } else {
	$url = 'http://aa-download.avg.com/filedir/inst/avg_free_x86_all_2014_4354a7223.exe'
  }
