...
elseif($LCID -eq "2058"){
$url = 'http://downloads-am.kasperskyamericas.com/files/trial/la/kav15.0.0.463ES_6312.exe'
}
#OK
##Dutch
...
##French
elseif($LCID -eq "1036"){
$url = 'http://trial.kaspersky-labs.com/trial/registered/60piihrlcs7omyvz96sv/kav15.0.1.415fr_6815.exe'
}
